...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView usernameLogin, passwordLogin, loginButton, registerInsteadLogin;
    Button buttonLogin;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        registerInsteadLogin = findViewById(R.id.registerInsteadLogin);
        ...
        registerInsteadLogin.setOnClickListener(new View.OnClickListener() {
            @Override
