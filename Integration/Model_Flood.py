...
# Import models
rfr_model, ref_columns, target = joblib.load('Flood_RFRModel.pkl')
xgb_model, ref_columns, target = joblib.load('Flood_XGBModel.pkl')
...
def predict_flood(location,location1,location2,district,month,day,rainfall):
    found= False
