...
//    private UserLocation.WeatherApi weatherApi;
...
//
//
//    private Context UserLocation3; // Add a context member
//
//
//
//
...
//                .build();
//
//        UserLocation2.WeatherApi weatherApi = retrofit.create(UserLocation2.WeatherApi.class);
...
//                                    //Toast.makeText(UserLocation3.this, "Forecast data is empty", Toast.LENGTH_SHORT).show();
//                                }
//                            } else {
//                                //Toast.makeText(UserLocation3.this, "Failed to fetch forecast data", Toast.LENGTH_SHORT).show();
//                            }
//                        }
//
//                        @Override
//                        public void onFailure(Call<JsonObject> call, Throwable t) {
//                            //Toast.makeText(UserLocation3.this, "Network error", Toast.LENGTH_SHORT).show();
//                        }
//                    });
//                } else {
//                    //Toast.makeText(UserLocation3.this, "Failed to fetch current weather data", Toast.LENGTH_SHORT).show();
//                }
//            }
//
//            @Override
...
////
////        Geocoder geocoder = new Geocoder(UserLocation3.this, Locale.getDefault());
////
////        try {
...
//        try (InputStream inputStream = assetManager.open("Rainfall_Daily_Average.csv")) {
//            // Read the inputStream as needed
...
//
//
//    public void controller(double latitude, double longitutde) {
//
//
//        getWeatherData(6.8581197,79.9220906);
//
//        //NearbyCities nearbyCities = getNearbyLocationNames(6.8581197, 79.9220906);
//
//    }
//}
